...
<body style="background-color:#FFFFFF;">
    ...
    <center>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color: coral; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 4px 4px 10px gray;">
            ...
            if (!$conn) {
                ...
                ?>
                <table class="table"
                    style="margin-top: 30px; background-color: lightsalmon; box-shadow: 4px 4px 15px black;">
                    <thead>
                        <tr>
