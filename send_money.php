...
<body style="background-color:#FFFFFF; padding-top:8%;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:90%; background-color:coral; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
            ...
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    <table>
                        <tr style="border-radius:30px; box-shadow: 1px 1px 2px coral; padding:5px 5px 5px 5px;">
                            <td>
                                <input type="text" class="formin form-control" name="accno1" id=""
                                    placeholder=" Account Number of Sender" value="<?php if (isset($_GET['reads'])) {
                                        echo $_GET['reads'];
                                    } ?>">
                            </td>
                        </tr>
                        ...
                        <tr style="border-radius:30px; box-shadow: 1px 1px 2px coral; padding:5px 5px 5px 5px;">
                            <td>
                                <input type="text" class="formin form-control" name="accno2" id=""
                                    placeholder=" Account Number of Receiver">
                            </td>
                        </tr>
                    </table>
                    <br><input class="btn mybtn btn-outline-light" type="submit" name="btn" value="Transfer"><br><br>
