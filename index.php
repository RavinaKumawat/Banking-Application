...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px coral;">
        <div class="container-fluid">
            <a href="index.php"><img src="statics\Sparks-logo.png" alt=""
    ...
    <div class="container-large"
        style="color:coral; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#FFFFFF;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:1px; text-shadow:3px 3px 3px grey; text-align:center;">Sparks
                        Bank</b></p>
            </div>
            <div class="col" style="margin:0% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/money.png" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="statics/img.png" alt="" style="width:100%; position:absolute; z-index:-1">
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:black;"><b> Facilities</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:coral; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
