...
<body style="padding-top:8%;">
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            <div
                style="width:80%; background-color:coral; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:black;">Contact Us</h1>
            </div>

            <div class="container"
                style="border-radius:5px; padding: 20px 20px 20px 20px; margin-top:50px; width:60%; box-shadow: 2px 2px 10px coral;">
