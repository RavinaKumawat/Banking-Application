...
<body style="background-color:#FFFFFF;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color: coral; padding:5px 5px 5px 5px; border-radius:40px; box-shadow: 4px 4px 10px gray;">
                <h1 style=" color:black;">About Us</h1>
            </div>
            <br><br>
            <img src="statics/avatar_icon.png" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:black;">This website is created by</p>
            <h1 style="color:black; text-shadow:2px 2px 2px gray;">Ravina Kumawat</h1>
            <p style="color:black;"><b>Address: Mahima Bank, Rajasthan.</b></p>
    </center>
